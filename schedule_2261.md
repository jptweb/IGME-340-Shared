...
- [ ] Confirm Fall 2026 will repeat Spring 2026's Week 8 grade structure (10% participation, all semester) or revisit
...
*This roadmap is a draft for Fall 2026 (term 2261). When ready to publish, move/rename to `IGME-340-Shared/schedule.md` (the existing Spring 2026 schedule should be archived first). Last updated: 2026-05-01.*
